...
class DeleteSpellCard extends Component {
    ...
    onDelete = (e) => {
        e.preventDefault();
        this.props.deleteSpellCard(this.props.cardItem._id)
        this.setState({
            modal: false,
        })
    }
...
const mapDispatchToProps = (dispatch) => {
    return {
        deleteSpellCard: (cardID) => {
            dispatch(deleteSpellCard(cardID))
        }
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(DeleteSpellCard);
