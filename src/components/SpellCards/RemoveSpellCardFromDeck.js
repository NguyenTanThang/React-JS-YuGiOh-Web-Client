...
class DeleteCard extends Component {
    ...
    onDelete = (e) => {
        this.props.removeSpellCardToDeck(this.props.cardItem._id, this.props.deckID)
        this.setState({
            modal: false,
        })
        setTimeout(() => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        removeSpellCardToDeck: (cardID, deckID) => {
            dispatch(removeSpellCardToDeck(cardID, deckID))
        }
    }
}
