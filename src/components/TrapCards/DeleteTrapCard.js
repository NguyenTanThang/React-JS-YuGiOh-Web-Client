...
class DeleteTrapCard extends Component {
    ...
    onDelete = (e) => {
        e.preventDefault();
        this.props.deleteTrapCard(this.props.cardItem._id)
        this.setState({
            modal: false,
        })
    }
...
const mapDispatchToProps = (dispatch) => {
    return {
        deleteTrapCard: (cardID) => {
            dispatch(deleteTrapCard(cardID))
        }
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(DeleteTrapCard);
