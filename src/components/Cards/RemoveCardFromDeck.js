...
class DeleteCard extends Component {
    ...
    onDelete = (e) => {
        e.preventDefault();
        this.props.removeMonsterCardToDeck(this.props.cardItem._id, this.props.deckID)
        this.setState({
            modal: false,
        })
        setTimeout(() => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        removeMonsterCardToDeck: (cardID, deckID) => {
            dispatch(removeMonsterCardToDeck(cardID, deckID))
        }
    }
}
