...
class AssignMonsterToCategory extends Component {
  ...
  onChange = (e) => {
    ...
    onSubmit = (e) => {
        ...
        this.props.addTrapCard({name, description, categoryID, imageURL});
        this.setState({
            modal: false,
            name: "",
            description: "",
...
render(){
    const {
      ...
      return (
        <div>
          <Button color="dark" onClick={toggle}>Create Trap Card</Button>
          <Modal isOpen={modal} toggle={toggle} className={className}>
            <ModalHeader toggle={toggle}>Create New Trap Card</ModalHeader>
            <ModalBody>
